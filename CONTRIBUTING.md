...
* Create an issue in the [GitHub repo](https://github.com/amunoz951/chef_bridge/issues)
...
* Make sure your commit messages are in the proper format. If the commit
  ...
  [GitHub repo](https://github.com/amunoz951/chef_bridge/issues), start
...
* Make sure you have added the necessary tests for your changes in the included
  chef_bridge_test cookbook and the inspec profile.
